export const STATES = Object.freeze({
  ...
  STAGE_3_QUESTIONS: 'STAGE_3_QUESTIONS',
...
// A stage can end (stage timer) during either its question or shooting state.
const TRANSITIONS = {
  ...
  [S.STAGE_1_QUESTIONS]: [S.STAGE_1_SHOOTING, S.STAGE_2_QUESTIONS, S.MENU],
  [S.STAGE_1_SHOOTING]: [S.STAGE_1_QUESTIONS, S.STAGE_2_QUESTIONS, S.MENU],
  [S.STAGE_2_QUESTIONS]: [S.STAGE_2_SHOOTING, S.STAGE_3_QUESTIONS, S.MENU],
  [S.STAGE_2_SHOOTING]: [S.STAGE_2_QUESTIONS, S.STAGE_3_QUESTIONS, S.RESULT, S.MENU],
  [S.STAGE_3_QUESTIONS]: [S.STAGE_3_BOSS, S.RESULT, S.MENU],
  [S.STAGE_3_BOSS]: [S.STAGE_3_QUESTIONS, S.RESULT, S.MENU],
...
export const QUESTION_STATES = new Set([S.STAGE_1_QUESTIONS, S.STAGE_2_QUESTIONS, S.STAGE_3_QUESTIONS]);
